...
import view.Teacher.ScheduleTeacherView;
import java.sql.*;
public class ScheduleTeacherCtrl {
	public ScheduleTeacherView view;
	String[] registeredClassCodes = {"C104","C105"};
	private int teacherID;
	public ScheduleTeacherCtrl(ScheduleTeacherView view) {
		super();
		this.view = view;
		
		teacherID= LoginController.teacherId;
	...
	public String[] getRegisteredClassCodes() {
	    ...
	    try {
	        // Thực hiện truy vấn để lấy các mã lớp đã đăng ký của học sinh từ bảng "teacherclassroom"
	        String query = "SELECT classCode FROM teacherClassroom WHERE teacherID = ?";
	        PreparedStatement pstmt = con.prepareStatement(query);
	        pstmt.setString(1, Integer.toString(teacherID));
