...
public class ExaminationView extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ExaminationView(StudentAccountMainView mainView) {
		 setLayout(null);
		            ...
		            public void valueChanged(ListSelectionEvent e) {
		                if (!e.getValueIsAdjusting()) {
		                    ...
		                    if (selectedRow != -1) {
		                        ...
		                        if (ExaminationController.hasExams(classCode)) {
		                            new Rules(classCode);
			...
			ExaminationController control= new ExaminationController(this);
	}
	...
	public void displayClassList(ClassesManager classes) {
	    ...
	    for (Classroom classroom : classes.getClassroomList()) {
	        Object[] rowData = new Object[3];  // Số cột là 3 thay vì 4
	        rowData[0] = classroom.getClassCode();
	        rowData[1] = classroom.getClassName();
	        
	        // Thêm trạng thái "Yes" hoặc "No" dựa trên có bài kiểm tra hay không
	        String examStatus = ExaminationController.getExamStatus(classroom.getClassCode());
	        rowData[2] = examStatus;
