...
import controller.Teacher.ScheduleTeacherCtrl;
...
public class ScheduleTeacherView extends JPanel {
    ...
    public ScheduleTeacherView() {
      ...
      //  add(scheduleTable);
        ...
        for(int i=0;i<6;i++) {
            ...
            ScheduleTeacherCtrl sechualeCtrl=new ScheduleTeacherCtrl(this);
